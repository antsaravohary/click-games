...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email','first_name' ,'last_name','password', 'is_active', 'siret','shop_id','employer_id'
    ];
     ...
     */
    public function managed_shops(): BelongsToMany
    {
        return $this->belongsToMany(Shop::class, 'staff_shop')
            ->withPivot('owner_id')
            ->withTimestamps();
    }
