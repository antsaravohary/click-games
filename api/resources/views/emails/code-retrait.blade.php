                                                ...
                                                <p style="line-height: 140%; font-size: 14px;"><span
                                                        style="line-height: 19.599999999999998px; font-size: 14px;"><strong><span
                                                                style="line-height: 19.599999999999998px; font-size: 14px;"><span
                                                                    style="font-size: 26px; line-height: 36.4px;">Click&amp;Collect
                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;"
                                            ...
                                            <div
                                                ...
                                                <p style="font-size: 14px; line-height: 210%;">Vous avez choisi le retrait
                                                    en Click&amp;Collect pour le(s) article(s) suivant :
                                                </p>
                                                @foreach ($products as $product)
                                                    <p style="font-size: 14px; line-height: 210%;">
                                                        <strong>{{ $product->name }}</strong></p>
                                                @endforeach
                                                <p style="font-size: 14px; line-height: 210%;">Vous pouvez retirer vos
                                                    articles à l'adresse-ci :</p>
                                                <p style="font-size: 14px; line-height: 210%;"><strong>{{ $address }}
                                                    </strong></p>
                                                <p style="font-size: 14px; line-height: 210%;"><strong>Boutique :
                                                        {{ $shop_name }}</strong></p>
                                                         <p style="font-size: 14px; line-height: 210%;"><strong>Téléphone :
                                                        {{ $telephone }}</strong></p>
                                                <p style="font-size: 14px; line-height: 210%;">&nbsp;</p>
                                                <p style="font-size: 14px; line-height: 210%;">L'utilisation d'un code de
                                                    retrait vous sera demandé pour retirer votre/vos article(s) veuillez le
                                                    garder précieusement.</p>
                                                <p style="font-size: 14px; line-height: 210%;">Commande
                                                    N°{{ $ref }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;"
                                            align="left">
                                            <div align="center">
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Montserrat',sans-serif;"><tr><td style="font-family:'Montserrat',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:36px; v-text-anchor:middle; width:94px;" arcsize="11%" stroke="f" fillcolor="#f1c40f"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
                                                <a href="" target="_blank"
                                                    style="box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #f1c40f; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                    <span style="display:block;padding:10px 20px;line-height:120%;"><span
                                                            style="font-size: 14px; line-height: 16.8px;">{{ $code_retrait }}</span></span>
                                                </a>
