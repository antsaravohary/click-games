                                                ...
                                                <p style=line-height:140%;font-size:14px><span
                                                        style=line-height:19.599999999999998px;font-size:14px><strong><span
                                                                style=line-height:19.599999999999998px;font-size:14px><span
                                                                    style=font-size:26px;line-height:36.4px>Merci d'avoir
                                                                    donné votre avis</span></span></strong></span></p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style=padding-right:0;padding-left:0 align=center>
                                                            @for ($i = 0; $i < $star; $i++)
                                                                <img src="{{asset('images/star.png')}}" alt=Image title=Image
                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:Montserrat,sans-serif"
                                            ...
                                            <div
                                                ...
                                                <p style=font-size:14px;line-height:210%>nous vous remercions d'avoir donné
                                                    votre avis sur un de nos articles en ligne. Votre avis compte pour nous
                                                    et va aider à orienter les futurs acheteurs potentiels dans leurs choix.
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
