                                                ...
                                                <p style="line-height: 140%; font-size: 14px;"><span
                                                        style="line-height: 19.599999999999998px; font-size: 14px;"><strong><span
                                                                style="line-height: 19.599999999999998px; font-size: 14px;"><span
                                                                    style="font-size: 26px; line-height: 36.4px;">Un petit
                                                                    cadeau</span></span></strong></span></p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                            <img src="{{asset('images/percent.png')}}" alt="Image" title="Image"
                                ...
                                <tbody>
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;"
                                            align="left">
                                            <div
                                                style="color: #686d6d; line-height: 100%; text-align: center; word-wrap: break-word;">
                                                <p style="font-size: 14px; line-height: 100%;">Parce que nous t'aimons, on a
                                                    décidé de te faire plaisir nous t'offrons un code de réduction !</p>
                                                <p style="font-size: 14px; line-height: 100%;">De 5% sur ta prochaine
                                                    commande.</p>
                                                <p style="font-size: 14px; line-height: 100%;">&nbsp;</p>
                                                <p style="font-size: 14px; line-height: 100%;">Valable uniquement en une
                                                    seule fois jusqu'au {{$expire_date}}</p>
                                                <p style="font-size: 14px; line-height: 100%;">&nbsp;</p>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;"
                                            align="left">
                                            <div align="center">
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Montserrat',sans-serif;"><tr><td style="font-family:'Montserrat',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.click-games.fr" style="height:36px; v-text-anchor:middle; width:93px;" arcsize="11%" stroke="f" fillcolor="#f1c40f"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
                                                <a href="www.click-games.fr" target="_blank"
                                                    ...
                                                    <span
                                                        style="display:block;padding:10px 20px;line-height:120%;">{{$ref}}</span>
                                                </a>
