                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div
                                style="color: #a6acb1; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%; font-size: 14px;"><span style="font-size: xx-small;">cet
                                    email &agrave; &eacute;t&eacute; envoy&eacute; &agrave; <a rel="noopener"
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{asset('images/image-3.png')}}" alt="Image" title="Image"
                              ...
                              <div align="center">
                                <div style="display: table; max-width:185px;">
                                  ...
                                  <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32"
                                    style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 30px">
                                    <tbody>
                                  ...
                                  <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32"
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                          <a href="https://twitter.com/ClickUniversFR" title="Twitter" target="_blank">
                                            <img src="{{asset('images/image-4.png')}}" alt="Twitter" title="Twitter" width="32"
                                              style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                          </a>
                                        </td>
                                      </tr>
                                  ...
                                  <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32"
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                          <a href="https://www.instagram.com/clickuniversfr/" title="Instagram"
                                            target="_blank">
                                            <img src="{{asset('images/image-6.png')}}" alt="Instagram" title="Instagram" width="32"
                                              style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                          </a>
                                        </td>
                                      </tr>
