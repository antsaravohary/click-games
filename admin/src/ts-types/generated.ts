...
export declare type User = {
  ...
  shops: [Shop];
  managed_shop: Shop;
  managed_shops?: Maybe<Array<Maybe<Shop>>>;
  is_active: Boolean;
...
export declare type TicketUpdateInput = {
...
export declare type UpdateOrder = {
  ...
  code_click_collect?: Scalars["String"];
  customer_id?: Maybe<Scalars["ID"]>;
  status?: Maybe<Scalars["ID"]>;
  click_collect_delivered?: Scalars["Boolean"];
  products?: Array<ConnectProductOrderPivot>;
  amount?: Maybe<Scalars["Float"]>;
...
export declare type CreatePromotion = {
  products: Array<Product>;
  delay: Scalars["Int"];
...
export declare type TicketPaginator = {
  paginatorInfo: PaginatorInfo;
  data: Array<Ticket>;
};
...
export declare type CreateMessageInput = {
  ...
  type: Scalars["String"];
  data_is_avalaible?: Scalars["Boolean"];
  purchase_id?: Scalars["ID"];
  data?: {};
};
