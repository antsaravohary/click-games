                ...
                (fieldAttributeValue: any, index: number) => {
                  return (
                     ...
                     *  <Input
                          label="Remise"
                          type="number"
                          {...register(`variation_options.${index}.remise`)}
                          error={t(
                            errors.variation_options?.[index]?.remise?.message
                          )}
                          variant="outline"
                          className="mb-5"
                        />
                     */}  
                        ...
                        <Input
                          label="Remise"
                          type="number"
                          {...register(`variation_options.${index}.discount`)}
                          error={t(
                            errors.variation_options?.[index]?.discount
                              ?.message
                          )}
                          defaultValue="0"
                          variant="outline"
                        ...
                        <Input
                          ...
                          {...register(`variation_options.${index}.weight`)}
                          error={t(
                            errors.variation_options?.[index]?.weight?.message
                          )}
                          variant="outline"
                          className="mb-5"
                        />
