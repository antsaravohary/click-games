...
const RepairActionFixed = ({ id }: any) => {
    ...
    <div className="bg-white shadow sm:rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        ...
        <div className="mt-2 max-w-xl text-sm text-gray-500">
          <p>
            Merci de confirmer uniquement quand la reparation de console est
            términé
          </p>
        </div>
        <div className="mt-5">
...
export default RepairActionFixed;
