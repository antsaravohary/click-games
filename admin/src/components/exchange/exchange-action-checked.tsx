...
const ExchangeActionChecked = ({ id }: any) => {
  ...
  const onValide = () => {
    mutate({
      variables: {
        id,
        input: {
          action: "confirm_exchange_checked",
        },
      },
    });
  };
    ...
    <div className="bg-white shadow sm:rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">
          Verification du colis
        </h3>
        <div className="mt-2 max-w-xl text-sm text-gray-500">
          <p>Merci de valider uniquement si le colis est authentique</p>
        </div>
...
export default ExchangeActionChecked;
