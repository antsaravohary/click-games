      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-wrap my-5 sm:my-8">
          ...
          <Card className="w-full sm:w-8/12 md:w-2/3">
            <div className="mb-8 card border p-4">
              <h4 className="text-base font-semibold text-body-dark mb-2">
                Mr {shopData?.shop?.balance?.payment_info?.name}
              </h4>
              <h4 className="text-base font-semibold text-body-dark mb-2">
                Banque: {shopData?.shop?.balance?.payment_info?.bank}
              </h4>
              <h4 className="text-base font-semibold text-body-dark mb-2">
                Numero de compte:{" "}
                {shopData?.shop?.balance?.payment_info?.account}
              </h4>
            </div>
            <Input
