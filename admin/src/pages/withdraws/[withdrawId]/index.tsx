...
const Withdraw = () => {
  ...
  const { price } = usePrice({
    amount: data?.withdraw?.amount as number,
  });
  ...
  return (
    ...
    <SEO title="Retraits"/>
      ...
      <div className="mb-8 card border p-4 bg-white">
        <h4 className="text-base font-semibold text-body-dark mb-2">
          Mr {data?.withdraw?.shop?.balance?.payment_info?.name}
        </h4>
        <h4 className="text-base font-semibold text-body-dark mb-2">
          Banque: {data?.withdraw?.shop?.balance?.payment_info?.bank}
        </h4>
        <h4 className="text-base font-semibold text-body-dark mb-2">
          Numero de compte:{" "}
          {data?.withdraw?.shop?.balance?.payment_info?.account}
        </h4>
      </div>
