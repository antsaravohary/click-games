...
import PromotionTypeList from "@components/promotoin-type/promotion-type-list";

export default function PromotionType() {
        ...
        <div className="w-full flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-3/4 flex flex-col md:flex-row items-center">
            <div className="w-full flex items-center">
              ...
              <LinkButton
                href={`${ROUTES.PROMOTION_TYPE}/create`}
