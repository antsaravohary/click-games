...
import SubscriptionButton from "@components/subscription/subscription";
...
export default function ShopPage() {
  ...
  const { data, isLoading: loading, error,refetch } = useShopQuery(shop!.toString());
  ...
  return (
    ...
    <div className="grid grid-cols-12 gap-6">
      ...
      <div className="order-3 xl:order-4 bg-light rounded col-span-12 sm:col-span-6 xl:col-span-3">
        <div className="flex flex-col p-6 2xl:p-7 text-lg border-b border-gray-100">
          Mon Abonnement
        </div>
        {is_active ? (
          <div className="flex flex-col p-6 2xl:p-7">
            <div className="flex flex-col space-y-3">
              <p className="text-sm text-sub-heading">
                <span className="text-muted block w-full">Type:</span>{" "}
                <span className="font-semibold">ClickSeller</span>
              </p>
              <p className="text-sm text-sub-heading">
                <span className="text-muted block w-full">Statuts:</span>{" "}
                <span className="font-semibold">
                  {is_expired ? "Expiré" : "Activé"}
                </span>
              </p>
              <p className="text-sm text-sub-heading">
          ...
          <div className="flex flex-col justify-center items-center aligns-center mt-8">
            <h4 className=" text-lg text-red-600"> Compte inactif</h4>
           
            <p className="text-gray-600">Abonnée vous pour activer votre compte</p>
            <SubscriptionButton
                onSuccess={()=>{refetch();
                reload();
                }}
