...
import StatusTypeFilter from "@components/withdraw/status-type-filter";
  ...
  return (
    <>
      ...
      <Card className="flex flex-col md:flex-row items-center justify-between mb-8">
        ...
        <StatusTypeFilter
          className="w-full md:w-1/3 md:ms-5 mt-5 mr-2 md:mt-0 flex-shrink-0"
          onStatusFilter={(e: { value: SetStateAction<string>; }) => {
         setStatus(e.value);
          }}
        />
