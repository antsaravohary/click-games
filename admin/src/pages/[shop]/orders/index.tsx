...
import StatusTypeFilter from "@components/order/status-type-filter";
    ...
    <>
      ...
      <Card className="flex flex-col md:flex-row items-center justify-between mb-8">
        ...
        <div className="w-full md:w-3/4 flex flex-col md:flex-row items-center ms-auto">
          ...
          <StatusTypeFilter
            className="w-full md:w-1/3 md:ms-5 mt-5 md:mt-0 flex-shrink-0"
            onStatusFilter={(e: { id: SetStateAction<number | undefined>; }) => {
