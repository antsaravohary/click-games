export const cguv = {
  title: `Conditions Générales d'Utilisation Vendeurs`,
  date: '01/01/2020',
  id: '4',
  content: [
    {
    ...
    {
      id: '4',
      title: `4. Obligations relatives aux transactions réalisées par l'intermédiaire du service`,
      description:
        ` <h5>4.1. Obligations d'ordre général</h5>
   <p>Le Vendeur doit s'identiﬁer auprès des Acheteurs comme agissant ou non en
           qualité de professionnel. Il s'engage expressément à s'identiﬁer comme agissant
           en qualité de Vendeur professionnel dès lors qu'il effectue des ventes de Produits
           par l'intermédiaire du Service de manière régulière et à des ﬁns lucratives.
           Le Vendeur s'engage à respecter la législation applicable en matière d'exercice
           d'une activité commerciale (notamment immatriculation, obligations comptables,
           sociales et ﬁscales). En effet, Le Vendeur peut être tenu de souscrire des
           déclarations ﬁscales et sociales au titre de son activité de vente de biens sur le
           Site. L’administration met à sa disposition des ﬁches précisant ses obligations en
           matière ﬁscale et sociale. <br />
           Le Vendeur s'engage également à respecter les lois et règlements qui lui
           incombent en sa qualité de professionnel eu égard notamment aux Produits qu'il
           vend sur le Site (tel que par exemple : déclaration auprès de l'Administration ﬁscale
           pour les Vendeurs de postes de télévision).
           <br />
           Par ailleurs, le Vendeur s'interdit expressément de promouvoir directement ou
           indirectement, sous quelque forme que ce soit (notamment par l'insertion de liens
           hypertextes, de tout message dans le descriptif des Produits, de tout imprimé dans es colis expédiés à l'Acheteur, ou encore par l'utilisation de l'adresse URL de son
           site Internet dans son identiﬁant ou sur la page Vendeur, ou par l’utilisation d’un
           carton d’emballage) ses produits ou services, de même que ceux de tout autre
   ...
   <h5>4.2. Obligations relatives aux offres de Produits sur le Site
   </h5>
   <p>Le Vendeur s'engage et garantit qu'il ne vendra que des Produits dont il est
           propriétaire ou sur lesquels il dispose des droits lui permettant de les vendre. Il
           garantit qu'ils ne contreviennent en aucune façon aux lois, règlementations en
           vigueur et normes applicables, obligatoires ou non (en particulier concernant la
           commercialisation des jeux, jouets) et qu'ils ne portent pas atteinte aux droits des
           tiers. Le Vendeur s'interdit à ce titre notamment de vendre tout Produit consistant
           en des œuvres contrefaisantes au sens du Code la propriété intellectuelle ou tout
           Produit dont la commercialisation est réglementée en vertu de dispositions
           législatives, règlementaires ou contractuelles (notamment en raison de l'existence
           d'un réseau de distribution sélective). Le Vendeur est seul responsable de la mise
           en vente des Produits qu'il propose sur le Service. <br />
           Le Vendeur s’interdit notamment de proposer sur le Site sans que cette liste soit
           limitative : des produits à caractère pornographique et plus généralement portant
           atteinte aux bonnes mœurs ; les biens incitant à la haine raciale ou objets de
           discrimination basée sur la race, le sexe, la religion, nationalité, les capacités
           physiques, l’orientation sexuelle ou l’âge ; les objets volés ; les médicaments ou
           drogues de tous types ; les armes, armes de guerre et munitions ; les animaux
           vivants ; les boissons alcooliques. <br /> Sur le descriptif associé aux offres de Produits qu'il propose sur le Site, le Vendeur
           s'engage à agir de bonne foi. Il est seul responsable de l'exactitude des mentions y
           ﬁgurant et s'engage à ce qu'elles ne risquent pas d'induire en erreur les Acheteurs
           potentiels, tant sur les caractéristiques du Produit, les garanties associées, que sur
           son état ou son prix. Concernant plus particulièrement les Produits d'occasion, le
           Vendeur devra faire un descriptif précis de l'état du Produit. Le Vendeur
           communique aux Acheteurs toutes les informations leur permettant de connaître
           les caractéristiques essentielles du Produit (le cas échéant, composition du Produit, accessoires compris, origine, les garanties légales, les modalités de leurs
           mises en œuvre, ou toutes autres conditions contractuelles etc.).
           Le Vendeur s'engage en outre à ce que les illustrations / visuels fournis dans le
           ...
           droit.
           <br />Le Vendeur devra également préciser dans le descriptif associé aux offres le pays
   ...
   <p>
           Le prix de vente des Produits est déﬁni librement par le Vendeur, dans le respect
   ...
   <p>
           Les contrats de vente des Produits proposés par le Vendeur sur le Site sont
           conclus entre le Vendeur et l’Acheteur. Le Vendeur s'engage à n'offrir sur le Site
           que des Produits disponibles et à supprimer sans délai du Site toute offre se
           ...
           Acheteurs. <br />
           La conﬁrmation de la commande par le Vendeur implique pour le Vendeur,
           l'engagement ferme d'expédier le(s) Produit(s) dans le délai visé au paragraphe 4.5
           (v) ci-dessous A défaut de réponse du Vendeur dans le délai auquel il est fait
           référence à l'alinéa précédent, le contrat de vente sera automatiquement annulé et
           le compte du Vendeur mis "en vacances".
           En cas d'absence ou d'indisponibilité de plus de 2 jours ouvrés, le Vendeur doit
           suspendre temporairement la mise en ligne de ses Produits à vendre à l'aide de
           l'outil "mise en vacances" mis à sa disposition sur le Service. <br />
           Le Vendeur s'engage à honorer au minimum 95 % des commandes des Produits
           proposés à la vente sur le Site depuis l’ouverture de son compte. A défaut, CLICK
           UNIVERS et pour les Vendeurs ayant réalisé au moins 5 ventes, se réserve le droit
           d'interrompre de manière temporaire ou déﬁnitive l'accès au Service au Vendeur
           concerné, en suspendant ou en résiliant les présentes dans les conditions prévues
           à l’article 8.
   </p>

   <h5>4.5. Obligations relatives à la livraison des Produits</h5>
   <p>
           (i)Le descriptif associé à chaque Produit présenté sur le Site indiquera les modes
           de livraison proposés pour la livraison de ce Produit.
           Les modalités de livraison suivantes peuvent être proposées, dans les conditions
           déﬁnies ci-après, à L'Acheteur :
           <ul>
                   <li>livraison normale</li>
                   <li>livraison en suivi</li>
                   <li>livraison contre signature</li>
           </ul>
   ...
   <p>
           ...
           Le Vendeur peut refuser de livrer le Produit commandé dans ce cas nous
           appliquons un remboursement à l’acheteur.

   </p>
   <p>
           (iii) Le Vendeur doit obligatoirement adresser à l'acheteur un bon de livraison du
           Produit acheté. Le Vendeur doit impérativement joindre à la livraison du Produit
           une facture d'achat ou tout autre document permettant le cas échéant à l’Acheteur
           de faire jouer sa garantie.
   ...
   <p>
           (vi) Le Vendeur s'engage à expédier tout Produit commandé dans les 2 jours
           ouvrés à compter de la conﬁrmation de la commande du Produit.
           Si le délai d’expédition du Vendeur est supérieur au délai susvisé, le Vendeur
           s’engage à en faire mention dans la ﬁche descriptive du Produit.
   </p>

   <h5>4.6. Obligations relatives aux contestations relatives aux Produits</h5>
   <p>De manière générale, le Vendeur s'engage à mettre en œuvre, de bonne foi, tous
           les moyens nécessaires aﬁn de remplir ses obligations en délivrant un service de qualité aux Acheteurs.
           A tout moment, l’Acheteur a la possibilité de contacter le Vendeur, d’adresser toute
           demande, réclamation relative aux Produits commandés en utilisant l’outil de
           messagerie mis à disposition dans le cadre du Service, notamment pour faire valoir
           ses garanties quand elles sont en cours. <br />
           En sus de l’outil de messagerie, il est mis à la disposition un bouton dédié
           permettant à , tout Acheteur de signaler dans son compte, et dans un délai de 90
           jours pour les achats effectués auprès d’un Vendeur professionnel, toute
           réclamation concernant les Produits commandés, (par exemple : produit non reçu,
           etc.).   <br />
           Au-delà de ces délais, l’Acheteur conserve la possibilité de contacter le Vendeur,
           de formuler toute demande relative aux Produits commandés en utilisant l’outil de
           ...
           Vendeur devra faire ses meilleurs efforts pour résoudre le litige l'opposant à
           ...
           UNIVERS au Vendeur au titre des ventes des Produits. Néanmoins, dans le cas où
...
<p>A défaut de conﬁrmation de la réception du produit par l'Acheteur et en l'absence
        de contestation de l'Acheteur portée à la connaissance du Vendeur dans le délai
...
<p>Chaque paiement pour les ventes du Vendeur serra émis le 5,10,25,30 de chaque
    ...
    },
    {
      ...
      description:
        ` <p>8.1 Les présentes Conditions Générales d’Utilisation sont conclues pour une durée
       ...
       affectant ses comptes, tel que notamment et sans que cette liste soit limitative:
       fraude, non-respect de ses obligations ﬁscales ou des engagements ﬁscaux
       ﬁgurant à l’article 2 des présentes, propos injurieux, contrefaçon, atteinte aux droits
       des tiers, non-respect de au moins un des indicateurs de qualité (...), CLICK
       UNIVERS pourra résilier les présentes CGU sans préavis et sans que le Vendeur
       ne puisse prétendre à une quelconque indemnité.<br />
       En particulier, un manquement grave est notamment constitué par (i) le non-
    ...
    },
    {
      ...
      description:
        ...
        place une plateforme de Règlement en Ligne des Litiges, facilitant le
        règlement indépendant par voie extrajudiciaire des litiges en ligne entre
        consommateurs et professionnels de l’Union européenne.
</p>
<p className="text-center">Cette plateforme est accessible au lien suivant : <a href="https://
        webgate.ec.europa.eu/odr/">https://
        webgate.ec.europa.eu/odr/</a>
</p>`
    },
    {
      id: '8',
      ...
      description:
       ...
       Gestion des demandes de droit d'accès, de rectiﬁcation et d'opposition ;<br />
       Opérations relatives à la prospection commerciale et proﬁlage publicitaire ;<br />
       Prévention de la fraude et gestion du risque ;<br />
       <strong>Traitements réalisés par Stripe :</strong><br />
       KYC, recertiﬁcation, exécution du contrat, gestion du produit et des services,,
...
<p>
       ...
       évaluations ou taux de satisfaction insufﬁsant...) et ainsi assurer aux
       Utilisateurs du Service une qualité de service optimale, les données
       personnelles du Vendeur collectées sur le site sont traitées par CLICK
       UNIVERS pour déterminer le niveau de risque de fraude et de conﬁance
       associé au compte Vendeur. Dans le cadre de cette analyse, CLICK
       UNIVERS est susceptible d’interroger ses prestataires spécialisés dans
       la prévention des risques pour afﬁner son analyse. Certains de ces
       prestataires sont en outre rendus destinataires du résultat de l’analyse
...
<p>A tout moment au cours de l’analyse de risque menée par CLICK GAMES,
       ...
       d’opposition. Pour exercer ces droits, vous pouvez vous adresser par
       voie électronique à <a hre="mailto:support@click-univers.com">support@click-univers.com</a> ou par courrier à CLICK
       UNIVERS Service Consommateur, 8 rue louis Aragon 25400 Audincourt,
       en nous indiquant vos nom, prénom, e-mail adresse et si possible votre
       référence client.
</p>
<p >Vendeurs situés en dehors du territoire de l’Union européenne :</p>
<p className="ml-2">Si vous exercez votre activité depuis un pays situé en dehors du territoire de
       l’Union européenne, vous vous engagez à traiter les données à caractère
       personnel qui vous sont communiquées conformément aux dispositions
       du Règlement UE 2016/679 du 27 avril 2016 (le « RGPD »). Vous
       ...
       permettant d’assurer qu’ils ne peuvent traiter les données que vous leur
       communiquez que sur instruction expresse de votre part et qu’ils sont
       tenus aux mêmes obligations que les vôtres en termes de protection des
    ...
    },
    {
      ...
      description:
        `  <p>11.1 - Tous les textes, commentaires, ouvrages, illustrations, œuvres et images
      reproduits ou représentés sur le Site sont strictement réservés au titre du droit d'auteur ainsi qu'au titre de la propriété intellectuelle, pour toute la durée de
      protection de ces droits et pour le monde entier. À ce titre et conformément aux
      dispositions du Code de la propriété intellectuelle, seule l'utilisation pour un usage
      privé, sous réserve de dispositions différentes voire plus restrictives du Code de la
      propriété intellectuelle, est autorisée. Toute reproduction ou représentation totale
...
<p>11.4 - CLICK GAMES se réserve le droit d’utiliser les droits de propriété
    ...
    {
      id: '11',
      title: `13. Nullité partielle`,
      description:
        `  <p>Si une ou plusieurs stipulations des présentes CGU Vendeur sont tenues pour non
      valides ou déclarées comme tel en application d'une loi, d'un règlement ou d'une
      décision déﬁnitive d'une juridiction compétente, les autres stipulations garderont
      toute leur force et toute leur portée</p>`
    },
    {
      id: '12',
      ...
      98 rue de Richelieu - 75002 Paris - <a href="https://www.economie.gouv.fr/mediateur-des-entreprises">www.economie.gouv.fr/mediateur-des-entreprises</a>.<br />
      En application de cette clause de médiation, tous les échanges effectués entre les
      parties seront, sauf accord des parties, conﬁdentiels pendant une durée illimitée.
      La durée de la médiation ne pourra excéder 3 mois, sauf accord contraire des
      parties.<br />
      En cas d'échec de la médiation, le différend sera tranché par les Tribunaux de
      PARIS, nonobstant pluralité de défendeurs ou appels en garantie, y compris pour
      les procédures en référé ou sur requêtes.
</p>`
    },
    {
      id: '13',
      title: `15. Anti-Corruption`,
      description:
        ` <p>Les Parties conviennent que, à tout moment en lien avec et pendant toute la durée
        du Contrat, et par la suite, elles se conformeront et prendront des mesures
        raisonnables pour s’assurer que leurs sous-traitants, leurs agents ou d’autres tiers,
        soumis à leur contrôle ou à leur inﬂuence déterminante, se conformeront aux
        dispositions suivantes.
        Les Parties interdiront les pratiques suivantes à tout moment et sous quelque
        forme que ce soit, à l’égard d’un agent public au niveau international, national ou
        local, d’un parti politique, d’un dirigeant de parti ou d’un candidat à des fonctions
        politiques, et d’un directeur, d’un agent ou d’un employé d’une Partie,
        indépendamment du fait que ces pratiques soient adoptées directement ou
        indirectement, y compris par l’entremise de tiers :
        a) La corruption désigne le fait d’offrir, de promettre, de donner, d’autoriser ou
        d’accepter tout avantage pécuniaire indu ou tout autre avantage indu à, de la part
        de ou pour l’une des personnes susmentionnées ou pour un tiers dans le but
        d’obtenir ou conserver un marché ou un autre avantage indu, par ex. en lien avec
        des attributions de contrats d’achat publics ou privés, des permis réglementaires, la
        ﬁscalité, les douanes ou des procédures judiciaires et législatives.<br></br>
        La corruption inclut notamment :
        <ul>
                <li> i. Le fait de remettre une partie d’un paiement d’un contrat à un
                        gouvernement ou des responsables de partis ou à des employés de l’autre
                        Partie contractante, leurs proches, leurs amis ou leurs partenaires
                        commerciaux ou à l’aide d’intermédiaires tels que des agents, des sous-
                        traitants, des consultants ou d’autres tiers, aﬁn d’attribuer des paiements à
                        un gouvernement ou des responsables de partis, ou à des employés de
                        l’autre Partie contractante, leurs proches, leurs amis ou leurs partenaires
                        commerciaux.</li>
                <li>ii. L'extorsion ou la sollicitation désigne la demande d’un pot-de-vin,
                        associée ou non à une menace si cette demande est refusée. Chaque
                        Partie s’opposera à toute tentative d’extorsion ou de sollicitation et est
                        invitée à signaler ces tentatives par le biais des mécanismes de rapport formels ou informels disponibles, à moins que ces rapports soient réputés
                        être contre-productifs compte tenu des circonstances.

                </li>
        </ul>
        b) Le traﬁc d’inﬂuence consiste à offrir ou à solliciter un avantage indu aﬁn
        d’exercer une inﬂuence inappropriée, réelle ou supposée, en vue d’obtenir auprès
        d’un agent public ou privé un avantage indu pour l’instigateur initial de l’acte ou
        pour toute autre personne.<br />
        c) Le fait de blanchir le produit des pratiques de corruption susmentionnées
        consiste à dissimuler ou déguiser l’origine, la source, le lieu, la disposition, le
