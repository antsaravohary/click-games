export const cga = {
        title: `Conditions Générales d'Utilisation Acheteurs`,
        date: '01/01/2020',
        id: '1',
        content: [
                {
                        ...
                        description:
                                ...
                                dans le but d'acheter des produits neufs et d'occasion (ci-après les "Produits")
                                proposés à un prix ferme (ci-après le "Service").
                                Parmi les produits d'occasion, sont vendus des produits dits Occasion : Comme
                                neuf, Occasion : Très bon, Occasion : Bon. Il s'agit par exemple de produits
                                d'exposition ou de retours clients qui auront été sortis de leur emballage d'origine
                                et manipulés. Les produits Occasion : Comme neuf, Occasion : Très bon, Occasion
                                : Bon sont dans un état comme neuf. Ils ont été testés et remis en atelier et
                                bénéﬁcient ainsi de la garantie déﬁnie par le Vendeur. Ils sont livrés avec
                                l'ensemble de leurs accessoires dans un emballage neutre neuf ou dans
                                l'emballage d'origine en état neuf.</p><p>
                                Pour utiliser le Service, l'Acheteur doit accepter de se soumettre aux présentes
                                Conditions Générales d'Utilisation Acheteur (ci-après les "CGU Acheteur ") sans
                                restriction ni réserve. Cette acceptation se matérialise par un clic de validation lors
                                de son inscription sur le Service.</p> <p>
                                Les ventes réalisées par l'intermédiaire du Service entre les Acheteurs et les
                ...
                },
                {
                        ...
                        description:
                                ` <p>Le Service est constitué d'un ensemble d'outils permettant aux Vendeurs de se
                                mettre en relation avec des Acheteurs, aﬁn de leur proposer des Produits à la
                                vente, de référencer et de décrire ces Produits, d'accepter les commandes
                                passées par les Acheteurs, de percevoir le prix des Produits achetés et de gérer le
                                service après-vente pour les Produits vendus.<br />
                                Les transactions effectuées via le Service pour les besoins de la vente des
                                ...
                                Par principe, le Vendeur est responsable des impôts, droits, taxes et éco-
                                contributions dus au titre de la transaction qu’il conclut avec un Acheteur. Par
                                exception, à compter du 1er juillet 2021, dans le cadre de transactions intervenant
                                ...
                                impose de respecter plusieurs conditions de forme permettant le contrôle
                                systématique des colis par l’administration des douanes. En particulier, le Vendeur
                                ...
                                manière automatique et certaine l’information sur un éventuel autre lieu
                                d’importation, le lieu d’importation est réputé être situé en France. En
                                conséquence, le Vendeur s’engage pour les commandes d’une valeur hors taxes et
                                hors frais de transport supérieure à 150 € et qui sont importés depuis un pays hors
                                UE à dédouaner le Produit en France.<br />
                                Le Vendeur reconnaît, pour chaque transaction avec un Acheteur, être pleinement
                                redevable des droits de douane dus au titre de l’introduction de Produits sur le
                                territoire de l’Union Européenne, s’engage à les régler dans leur intégralité et à les
                                intégrer dans le prix de vente hors taxes des Produits. En aucune façon les droits
                                de douane acquittés au titre des Produits ne doivent être facturés séparément ou
                                laissés à la charge de l’Acheteur</p>`
                },
                {
                        id: '4',
                        title: `>3. Accès au service`,
                        description:
                                `<p>L'accès au Service par les Acheteurs est réservé à une utilisation strictement
                                personnelle. Lorsqu'il utilise le Service, l'Acheteur déclare agir à titre privé.
                                Outre l'acceptation des présentes CGU Acheteur, l'accès au Service est
                                subordonné à l'ouverture d'un compte sur le Site. Vous devez pour cela fournir les
                                données permettant votre identiﬁcation. Lors de l'ouverture de ce compte, Vous
                                Vous engagez à ne fournir que des informations exactes, puis à informer CLICK
                                UNIVERS sans délai de tout changement les affectant, en utilisant l'outil de
                                messagerie mis à votre disposition dans le cadre du Service.<br />
                                Pour utiliser le Service, Vous devez utiliser l'identiﬁant et le mot de passe créés lors
                                de l'ouverture de votre compte. Vous Vous engagez à les conserver secrets et à ne
                                les divulguer à aucun tiers. En effet, Vous serez seul responsable de l'accès au
                                Service grâce à vos identiﬁant et mot de passe, sauf preuve d'une utilisation
                ...
                {
                        id: '5',
                        title: `4. Prix du service`,
                        description:
                                `<p>L'ouverture d'un compte et l'utilisation du Service sont gratuit (hors couts éventuels
                                        de la connexion, dont le prix dépend de votre opérateur de communication
                                        électronique).</p>`
                },
                {
                        id: '6',
                        ...
                        <p>Les informations relatives à votre compte et celles de vos commandes sont
                                ...
                                compte ou celui de partenaires dans le cadre de sa régie publicitaire. En
                                fonction de vos choix, vos données de contact et information de proﬁls
                        ...
                        <p>Les informations nécessaires au marquage de votre vélo sont collectées
                                ...
                                FNUCI pour permettre l’identiﬁcation de votre vélo en cas de perte ou vol.
                                Ce traitement obligatoire est fondé sur le Décret no 2020-1439 du 23
                                novembre 2020 relatif à l’identiﬁcation des cycles.
                        </p>
                        <p><u>Vos droits :
                        </u></p>
                        <p>S’agissant des données traitées dans le cadre de l’identiﬁcation de votre
                                vélo, vous pouvez exercer vos droits (accès, rectiﬁcation, limitation) et
                                déﬁnir le sort de vos données personnelles « post mortem » directement
                                auprès de l’opérateur agréé. Le droit d’opposition n’est pas applicable à
                                ce traitement, car l’identiﬁcation est nécessaire pour la vente du vélo.</p>
                        <p>Vous pouvez exercer vos droits (accès, rectiﬁcation, suppression, opposition,
                ...
                },
                {
                        ...
                        description:
                                `<p>6.1 - Tous les textes, commentaires, ouvrages, illustrations, œuvres et images
                                reproduits ou représentés sur le Site sont strictement réservés au titre du droit
                                d'auteur ainsi qu'au titre de la propriété intellectuelle, pour toute la durée de
                                ...
                                propriété intellectuelle, est autorisée. Toute reproduction, représentation,
                                modiﬁcation ou adaptation totale ou partielle du Site et/ou de tout ou partie des
                                éléments se trouvant sur le Site ou qui y sont incorporés est strictement interdite.<br />
                                6.2 - Les dénominations sociales, marques et signes distinctifs reproduits sur le
                                Site sont protégés au titre du droit des marques. La reproduction ou la
                                représentation de tout ou partie d'un des signes précités est strictement interdite et
                ...
                {
                        id: '9',
                        title: `8. Nullité partielle`,
                        description:
                                ` <p>Si une ou plusieurs stipulations des présentes CGU Acheteur sont tenues pour non
                ...
                {
                        id: '10',
                        title: `9. Loi applicable et traitement des réclamations au
                        titre du Service - Règlement en ligne des litiges.`,
                        description:
                                ...
                                Vous rencontrez un problème avec une commande : <a href="http://www.fevad.com/mediation">www.fevad.com/mediation</a>
                        </p>
                        <p><strong><u>Plateforme de Règlement en Ligne des Litiges :</u></strong> Conformément à l’article
                                ...
                                consommateurs et professionnels de l’Union européenne.</p>
                        <p className="text-center">Cette plateforme est accessible au lien suivant : <a href="https://webgate.ec.europa.eu/odr">webgate.ec.europa.eu/odr</a></p>`
                },
